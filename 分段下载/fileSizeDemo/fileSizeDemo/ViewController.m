...
-(void)downloadFile:(NSString *)fileName startByte:(long long)start endByte:(long long)end{
    ...
    NSMutableURLRequest *request= [NSMutableURLRequest requestWithURL:[NSURL URLWithString:DownLoadUrl] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:5.0f];
